...
async def generate_assessment(patient_data: dict) -> str:
    ...
    try:
        ...
        return "⚠️ حدث خطأ في معالجة طلبك. يرجى المحاولة مرة أخرى بعد قليل."
...
async def handle_confirmation(query, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if query.data == "confirm_yes":
        ...
        await query.message.edit_text(processing_text, parse_mode=ParseMode.MARKDOWN)
